...
def seed() -> None:
    ...
    with Session(engine) as session:
        ...
        assets = [
            ...
            Asset(name="paisajes-4k.mp4",  type="video",  size_mb=15000, project_id=p3.id),
        ...
        tags = {n: Tag(name=n) for n in ["hd", "4k", "color-graded", "raw", "final"]}
        ...
        session.commit()
        print("Seed completado: 3 clientes, 5 proyectos, 8 assets")
